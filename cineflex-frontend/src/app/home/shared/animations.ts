...
export const animations = 
    trigger('routeAnimations', [
        ...
        transition('Homepage <=> *, * <=> MovieDetails, Home <=> *, Admin <=> *, Auth <=> *, ProfileDetails <=> *, AllNews <=> *, NewsDetails <=> *, NewsCategory <=> *, AdminCredentials <=> *, MovieType <=> *, MovieCategory <=> *, About <=> *, PageNotFound <=> *', fadeEffect()),
    ]);
